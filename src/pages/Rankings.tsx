...
const Rankings = () => {
  const rankings = [
    { position: 1, team: "Senior Men", points: 45, matches: 15, wins: 14, draws: 3, losses: 0 },
    { position: 2, team: "Senior Women", points: 38, matches: 15, wins: 12, draws: 2, losses: 1 },
    { position: 3, team: "U21 Men", points: 32, matches: 14, wins: 10, draws: 2, losses: 2 },
    { position: 4, team: "U19 Women", points: 28, matches: 14, wins: 9, draws: 1, losses: 4 },
    { position: 5, team: "U17 Mixed", points: 24, matches: 13, wins: 7, draws: 3, losses: 3 },
  ];
                        ...
                        <tr key={team.position} className="border-b hover:bg-gray-50">
                          <td className="p-4">
                            <div className="flex items-center gap-2">
                              ...
                              {team.position === 2 && <Medal className="w-4 h-4 text-gray-400" />}
                              {team.position === 3 && <Target className="w-4 h-4 text-amber-600" />}
                          ...
                          <td className="p-4 text-center text-green-600">{team.wins}</td>
