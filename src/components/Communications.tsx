            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                <Card>
                  <CardContent className="p-3 sm:p-4">
                    ...
                    <p className="text-xs sm:text-sm text-gray-600">Active Announcements</p>
                  </CardContent>
                </Card>
                <Card>
                  <CardContent className="p-3 sm:p-4">
                    <div className="text-lg sm:text-2xl font-bold text-green-600">45</div>
                    <p className="text-xs sm:text-sm text-gray-600">Messages Today</p>
                  </CardContent>
                </Card>
                <Card>
                  <CardContent className="p-3 sm:p-4">
                    <div className="text-lg sm:text-2xl font-bold text-orange-600">8</div>
                    <p className="text-xs sm:text-sm text-gray-600">Unread Notifications</p>
                  </CardContent>
                </Card>
                <Card>
                  <CardContent className="p-3 sm:p-4">
                    <div className="text-lg sm:text-2xl font-bold text-purple-600">156</div>
              ...
              <Tabs defaultValue="announcements" className="w-full">
                <TabsList className="grid w-full grid-cols-3">
                  <TabsTrigger value="announcements" className="flex items-center gap-1 sm:gap-2 text-xs sm:text-sm">
